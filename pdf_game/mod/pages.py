...
def _render_tutorial(pdf, start_page_id):
    ...
    bitfont_render(pdf, 'A song will start in your', 80, 70, Justify.CENTER)
    bitfont_render(pdf, ' web browser. Keep the music', 80, 80, Justify.CENTER)
    bitfont_render(pdf, 'playing in the background,', 80, 90, Justify.CENTER)
    bitfont_render(pdf, '& switch back to the game.', 80, 100, Justify.CENTER)
